...
# network parameter
flags.DEFINE_integer('batch_size', 2, 'the training batch size')
flags.DEFINE_integer('img_size', 256, 'the size of input images')
flags.DEFINE_integer('num_channels', 3, 'the channel of the input images')
flags.DEFINE_integer('classes', 2, 'the number of the classes, including the background')

# hyper parameter
flags.DEFINE_float('learning_rate', 1e-4, 'the init learning rate')
flags.DEFINE_integer('max_steps', 18150, 'the init learning rate')
